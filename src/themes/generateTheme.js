      ...
      if (Object.hasOwnProperty.call(obj, key)) {
        ...
        const a = `{
          ...
          "colors" : {
            ...
            "accentHover": "${gen(element['--accentHover'])}",
            "primary": "${gen(element['--primary'])}",
            "primaryHover":  "${gen(element['--primaryHover'])}",
            "mainText":  "${gen(element['--mainText'])}",
            "secondaryText":  "${gen(element['--secondaryText'])}",
            "playerDownloadProgress":  "${gen(element['--playerDownloadProgress'])}"
          }
        }`;
